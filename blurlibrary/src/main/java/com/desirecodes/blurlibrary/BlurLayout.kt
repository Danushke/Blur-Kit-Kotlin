...
class BlurLayout : FrameLayout {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        ...
        try {
            ...
            mCornerRadius =
                a.getDimension(R.styleable.BlurLayoutt_blk_cornerRadius, DEFAULT_CORNER_RADIUS)
    ...
    private val invalidationLoop: FrameCallback = object : FrameCallback {
     ...
     * See [.mDownscaleFactor].
     */
    var downscaleFactor: Float = 0.0f
